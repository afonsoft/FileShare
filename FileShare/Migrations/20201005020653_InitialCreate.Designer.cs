...
namespace FileShare.Migrations
{
    ...
    [Migration("20201005020653_InitialCreate")]
            ...
            modelBuilder.Entity("FileShare.Repository.Model.ExtensionPermittedModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("df6c8e39-0d29-4a36-bbff-b3eea149d366"),
                            CreationDateTime = new DateTime(2020, 10, 4, 23, 6, 51, 229, DateTimeKind.Local).AddTicks(4256),
                            Extension = ".zip"
                        });
                });
