...
namespace FileShare.Migrations
{
    ...
    [Migration("20201007172313_ChangeMaxLengthExtension")]
    partial class ChangeMaxLengthExtension
    {
            ...
            modelBuilder.Entity("FileShare.Repository.Model.ExtensionPermittedModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("904d07de-5da7-4a28-8986-c1695637e1bf"),
                            CreationDateTime = new DateTime(2020, 10, 7, 14, 23, 11, 387, DateTimeKind.Local).AddTicks(2937),
