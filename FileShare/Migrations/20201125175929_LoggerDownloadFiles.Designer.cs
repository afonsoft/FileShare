...
namespace FileShare.Migrations
{
    ...
    [Migration("20201125175929_LoggerDownloadFiles")]
    partial class LoggerDownloadFiles
    {
            ...
            modelBuilder.Entity("FileShare.Repository.Model.ExtensionPermittedModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1e81ee22-59fe-4ab5-82b1-50bb3ead4642"),
                            CreationDateTime = new DateTime(2020, 11, 25, 17, 59, 26, 826, DateTimeKind.Utc).AddTicks(9851),
